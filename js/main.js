...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const partyGames=[
    ["KING'S CUP","PLAYERS TAKE TURNS DRAWING CARDS, WITH EACH VALUE ASSIGNED TO A DIFFERENT RULE OR CHALLENGE. COMPLETE THE ACTION BEFORE THE NEXT PLAYER DRAWS. THE PLAYER WHO DRAWS THE FINAL KING MUST DRINK THE KING'S CUP."],
    ["BUSFAHRER","ONE PLAYER IS CHOSEN AS THE BUS DRIVER AND MUST GUESS A SERIES OF CARDS BY ANSWERING QUESTIONS ABOUT THEIR COLOR, VALUE OR POSITION. EVERY WRONG ANSWER MEANS DRINKING AND STARTING AGAIN UNTIL THE ENTIRE ROW IS CLEARED."],
    ["PYRAMIDE","BUILD A PYRAMID OF FACE-DOWN CARDS. TURN THEM OVER ONE BY ONE, AND IF YOU HOLD A MATCHING VALUE, ASSIGN THE CORRESPONDING NUMBER OF DRINKS TO ANOTHER PLAYER. THE HIGHER THE CARD, THE MORE DRINKS CAN BE GIVEN."],
    ["HIGHER OR LOWER","PREDICT WHETHER THE NEXT CARD WILL BE HIGHER OR LOWER THAN THE CURRENT ONE. A CORRECT GUESS LETS YOU CONTINUE, WHILE A WRONG GUESS ENDS YOUR TURN AND RESULTS IN A DRINK."]
  ];
