...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateHero() {
    ...
    const heroShift = innerWidth < 900 ? (progress * -150) : (progress * -90);
    document.querySelector(".hero-word").style.setProperty("--hero-shift", `${heroShift}px`);
  }
  ...
  const galleryItems=[
    ["assets/images/hero-card-01.png","THE CLUB","THE CENTRAL CLUB SYMBOL COMBINES THE SUIT WITH THE DECK’S ORNAMENTAL LANGUAGE."],
    ["assets/images/hero-card-02.png","THE JACK","A CONTEMPORARY FIGURE CARRYING AN ETHIOPIAN ORTHODOX CROSS."],
    ["assets/images/hero-card-03.png","THE WALIA IBEX","AN ETHIOPIAN HIGHLAND ANIMAL TRANSLATED INTO A REDUCED, GEOMETRIC SILHOUETTE."],
    ...
    ["assets/images/illus-lion.jpg","THE LION","A SYMBOL OF STRENGTH AND SOVEREIGNTY, REDUCED INTO ANGULAR ORNAMENTAL PLANES."]
  ];
  ...
  if(mobileGallery){
    mobileGallery.innerHTML=galleryItems.map((item,index)=>`
      <article class="mobile-gallery-slide">
